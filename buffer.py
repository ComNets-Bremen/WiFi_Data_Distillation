...
def main(args):
    ...
    if args.dataset in ["+++", "+++"] and not args.zca:
        save_dir += "_NO_ZCA"
    ...
    args.dc_aug_param['strategy'] = 'none'  # for whole-dataset training
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='slnet', help='dataset')
